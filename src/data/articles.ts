export const articles = [
  {
    id: 1,
    category: "react",
    thumbnail: "https://via.placeholder.com/200x150?text=React+Article",
  ...
  },
  {
    id: 2,
    category: "vue",
    thumbnail: "https://via.placeholder.com/200x150?text=Vue+Article",
    title: "Getting Started with Vue.js 3 and the Composition API",
    description:
  ...
  },
  {
    id: 3,
    category: "qwik",
    thumbnail: "https://via.placeholder.com/200x150?text=Qwik+Article",
    title: "Qwik: The Performance-first Web Framework",
    description:
  ...
  },
  {
    ...
    category: "react",
    thumbnail: "https://via.placeholder.com/200x150?text=React+Article",
    title: "React Server Components: A New Approach to Rendering",
    description:
  ...
  },
  {
    ...
    category: "vue",
    thumbnail: "https://via.placeholder.com/200x150?text=Vue+Article",
    title: "Building Reusable Components with Vue.js Slots",
    description:
  ...
  },
  {
    ...
    category: "react",
    thumbnail: "https://via.placeholder.com/200x150?text=React+Article",
    title: "Optimizing React Applications with useMemo and useCallback",
    description:
  ...
  },
  {
    ...
    category: "vue",
    thumbnail: "https://via.placeholder.com/200x150?text=Vue+Article",
    title: "Vue.js Directives: Enhancing Your HTML",
    description:
  ...
  },
  {
    ...
    category: "qwik",
    thumbnail: "https://via.placeholder.com/200x150?text=Qwik+Article",
    title: "Qwik: Implementing Efficient State Management",
    description:
  ...
  },
  {
    ...
    category: "react",
    thumbnail: "https://via.placeholder.com/200x150?text=React+Article",
    title: "React Router: Mastering Client-Side Navigation",
    description:
  ...
  },
  {
    ...
    category: "vue",
    thumbnail: "https://via.placeholder.com/200x150?text=Vue+Article",
    title: "Managing State with Vuex: A Complete Guide",
    description:
  ...
  },
  {
    ...
    category: "qwik",
    thumbnail: "https://via.placeholder.com/200x150?text=Qwik+Article",
    title: "Qwik SEO: Best Practices for Optimizing Your Qwik Applications",
    description:
